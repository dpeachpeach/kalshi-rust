...
This wrapper is asynchronous and typically more performant than the official Python API provided by the developers, present here. [KalshiDevAPI](https://github.com/Kalshi/kalshi-python)
